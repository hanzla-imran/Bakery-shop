        ...
        <div class="col-12">
            <div class="card table-card ">
                <div class="card-header d-flex align-items-center justify-content-between py-3">
                    ...
                    <a type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exleModal">Add Data</a>
                    <!-- modal -->

                    <div class="modal fade" id="exleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    <div class="container my-2">
                                        <form class="w-100" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                <label for="emailedit" class="col-sm-2 col-form-label">Image icon</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="row mb-3">
                                                <label for="emailedit" class="col-sm-2 col-form-label">Background image</label>
                                                <div class="col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-primary my-3" name="buttonnn">Insert Data</button>
                                    </form>
                                </div>
                ...
                <td>" . $x . "</td>
                <td>" . $row['id'] . "</td>
                 <td '><img  style ='width:100px' src='" . $row['img_icon'] . "' ></td>
                 <td '><img  style ='width:100px' src='" . $row['background_img'] . "' ></td>
                <td>" . $row['heading'] . "</td>
                <td>" . $row['link'] . "</td>
                ...
                <td>
                                    ...
                                    <a type='button' class='btn btn-icon btn-bg-light btn-active-color-primary btn-sm' data-bs-toggle='modal' data-bs-target='#stBackdrop" . $row['id'] . "'>
                                   ...
                                   <i class='ti ti-trash f-20'></i>
                                    ...
                                    ?>
                                                        ...
                                                        <div class="container my-2">
                                                            <form class="w-100" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <img  style ='width:100px' src="<?php echo $row['img_icon']; ?>" alt="">
                                                                    <span class="text-danger"> </span>
                                                                </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                    <img  style ='width:60px' src="<?php echo $row['background_img']; ?>" alt="">
                                                                    </div>
                                                                    <span class="text-danger"> </span>
                                                                </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    <label for="emailedit" class="col-sm-2 col-form-label">Heading</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" name="head" value="<?= $row['heading'] ?>">
                                                                    </div>
                                                                    <span class="text-danger"> </span>
                                                                </div>
                                                                <div class="row mb-3">
                                        ...
                                        <!-- modal 2 -->
                                        <div class="modal fade" id="stBackdrop<?= $row['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel<?= $row['id'] ?>" aria-hidden="true">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-footer">
                                                <form method="POST">
                                                    ...
                                                    <button type="submit" class="btn btn-danger" name="btn_del">Yes, Delete</button>
