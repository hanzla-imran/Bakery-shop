...
if (!empty($userid)) {
include "../../controller/section_4.php";
...
<div class="pc-container">
    ...
    <div class="page-header">
        ...
        <h2 class="mb-3">Section 4</h2>
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Section 4 p-1st</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="true">Section 4 p-3rd</a>
            </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                ...
                <td>" . $row['id'] . "</td>
                <td>" . $row['heading'] . "</td>
                 <td '><img  style ='width:100px' src='" . $row['banner'] . "' ></td>
                                                                ...
                                                                <div class="container my-2">
                                                                    <form class="w-100" method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input type="text" class="form-control" name="headi" value="<?php echo $row['heading']; ?>">
                                                                            </div>
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <div class="col-sm-4">
                                                                                <img style ='width:100px' src="<?php echo $row['banner']; ?>" alt="">
                                                                            </div>
                                                                            <span class="text-danger"> </span>
                                                                        </div>
        ...
        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container my-2">
                                <form class="w-100" method="POST" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        <label for="emailedit" class="col-sm-2 col-form-label">Profile</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        <label for="emailedit" class="col-sm-2 col-form-label">Comments</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        <label for="emailedit" class="col-sm-2 col-form-label">Identity</label>
                                        <div class="col-sm-10">
                            ...
                            <button type="submit" class="btn btn-primary my-3" name="bttnn">Insert Data</button>
                            </form>
                        </div>
            ...
            <div class="col-12 ">
                ...
                <td>" . $x . "</td>
                <td>" . $row['id'] . "</td>
                <td '><img  style ='width:100px' src='" . $row['profile'] . "' ></td>
                <td>" . $row['comments'] . "</td>
                <td>" . $row['name'] . "</td>
                <td>" . $row['identity'] . "</td>
                                                            ...
                                                            <div class="container my-2">
                                                                <form class="w-100" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <img  style ='width:100px' src="<?php echo $row['profile']; ?>" alt="">
                                                                        </div>
                                                                        <span class="text-danger"> </span>
                                                                    </div>
                                                                    <div class="row mb-3">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <label for="emailedit" class="col-sm-2 col-form-label">Identity</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control" name="identity" value="<?php echo $row['identity']; ?>">
                                                                        </div>
                                                                        <span class="text-danger"> </span>
                                                                    </div>
