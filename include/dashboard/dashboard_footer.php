      ...
      <div class="footer-wrapper container-fluid">
        <div class="row">
          <div class="col-sm-6 my-1">
            <!-- <p class="m-0">Made with &#9829; by <a href="/" target="_blank"> Hanzla Imran</a></p> -->
          </div>
          <div class="col-sm-6 ms-auto my-1">
            <ul class="list-inline footer-link mb-0 justify-content-sm-end d-flex">
              <!-- <li class="list-inline-item"><a href="../../views/admin/admin.php">Home</a></li> -->
            </ul>
          </div>
        </div>
      </div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <script src="../../assets2/js/plugins/jsvectormap.min.js"></script>
    <script src="../../assets2/js/plugins/world.js"></script>
    <script src="../../assets2/js/plugins/world-merc.js"></script>
