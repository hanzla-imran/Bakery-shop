  ...
  <ul class="list-unstyled">
    ...
    <li class="dropdown pc-h-item header-user-profile">
      <a
        ...
        aria-expanded="false"
      >
        <img src="../../assets2/images/user/avatar-1.jpg" alt="user-image" class="user-avtar" />
      </a>
        ...
        <div class="dropdown-body">
          <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
            <ul class="list-group list-group-flush w-100">
              <li class="list-group-item">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="../../assets2/images/user/avatar-1.jpg" alt="user-image" class="wid-50 rounded-circle" />
                  </div>
                  <div class="flex-grow-1 mx-3">
                    <h5 class="mb-0"><?= $_SESSION['banno']['name'] ?></h5>
                    <a class="link-primary" href=""><?= $_SESSION['banno']['email'] ?></a>
                  </div>
              ...
              <li class="list-group-item">
                ...
                <!-- <a href="#" class="dropdown-item">
                  ...
                  <div class="user-group">
                    <img src="assets2/images/user/avatar-1.jpg" alt="user-image" class="avtar" />
                    <img src="assets2/images/user/avatar-2.jpg" alt="user-image" class="avtar" />
              ...
              <li class="list-group-item">
                <a href="../../views/admin/edit_profile.php" class="dropdown-item">
                  <span class="d-flex align-items-center">
              ...
              <li class="list-group-item">
                <a href="../../views/admin/add_account.php" class="dropdown-item">
                  <span class="d-flex align-items-center">
                    <i class="ph-duotone ph-plus-circle"></i>
                    <span>Add account</span>
                  </span>
                </a>
                <a href="../../controller/sign_out.php" class="dropdown-item">
                  <span class="d-flex align-items-center">
